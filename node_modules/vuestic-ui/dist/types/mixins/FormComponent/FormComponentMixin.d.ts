...
export declare class FormComponentMixin extends FormComponentMixin_base {
    ...
    formProvider: import("vue").ShallowUnwrapRef<{
        onChildMounted?: ((child: import("../../components/va-form/consts").Form | import("../../components/va-form/consts").FormChild) => void) | undefined;
        onChildUnmounted?: ((child: import("../../components/va-form/consts").Form | import("../../components/va-form/consts").FormChild) => void) | undefined;
    }>;
    mounted(): void;
    unmounted(): void;
    /** @public */
