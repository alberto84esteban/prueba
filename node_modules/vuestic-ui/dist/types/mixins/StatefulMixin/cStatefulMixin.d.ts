 ...
 */
export declare function useStateful<T, D extends T | undefined>(props: {
    [key: string]: any;
    modelValue?: T;
}, emit: (event: 'update:modelValue', ...args: any[]) => void, defaultValue?: D): {
    valueComputed: import("vue").WritableComputedRef<D>;
};
/**
