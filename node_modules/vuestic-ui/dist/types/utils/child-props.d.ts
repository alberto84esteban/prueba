 ...
 */
export declare const filterComponentProps: <T extends Record<string, unknown>, K extends Record<keyof T, unknown>>(propsValues: K, childProps: T) => ComputedRef<{ [K_1 in keyof T]: K[K_1]; }>;
